...
from solar_and_storage.example import internal_consumption, prices, with_solar

HTML_OUTPUT = "" # set path or empty will skip writing HTML
PNG_OUTPUT = "examples/images/battery_solar_internal_load.png" # empty will skip writing PNG

# use example prices and solar generation profile
solar_and_storage = SolarAndStorage(prices=prices,
                                    solar_generation=list(with_solar),
                                    internal_consumption=list(internal_consumption))
